...
public class RectangularMapTest {
    ...
    void _place(){
        ...
        Assertions.assertTrue(this.map.place(new Animal(this.map,new Vector2d(10,4))));
    ...
    void _objectAt(){
        ...
        Animal animal2 = new Animal(this.map,new Vector2d(5,5));
        ...
        Assertions.assertEquals(animal2,this.map.objectAt(new Vector2d(5,5)));
