...
public class RectangularMapTest {
    ...
    void _canMoveTo(){
        ...
        Assertions.assertTrue(this.map.canMoveTo(new Vector2d(9,3)));
    ...
    void _place(){
        ...
        Assertions.assertTrue(this.map.place(new Animal(this.map,new Vector2d(5,4))));
        Assertions.assertTrue(this.map.place(new Animal(this.map,new Vector2d(9,4))));
    ...
    void _isOccupied(){
        ...
        Assertions.assertFalse(this.map.isOccupied(new Vector2d(9,3)));
        Assertions.assertFalse(this.map.isOccupied(new Vector2d(3,3)));
    }
    @Test
    void _objectAt(){
        Animal animal1 = new Animal(this.map,new Vector2d(2,3));
        Animal animal2 = new Animal(this.map,new Vector2d(4,4));
        ...
        Assertions.assertEquals(animal2,this.map.objectAt(new Vector2d(4,4)));
